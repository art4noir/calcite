...
public class StandardConvertletTable extends ReflectiveConvertletTable {
  ...
  private static class RegrCovarianceConvertlet implements SqlRexConvertlet {
    ...
    private SqlNode expandCorr(
        final SqlNode arg1, final SqlNode arg2,
        final RelDataType avgType, final SqlRexContext cx) {
      final SqlParserPos pos = SqlParserPos.ZERO;
      final SqlNode covarPop = expandCovariance(arg1, arg2, null, avgType, cx, false, false);
      final SqlNode stddevPop1 = expandCovariance(arg1, arg1, null, avgType, cx, false, true);
      final SqlNode stddevPop2 = expandCovariance(arg2, arg2, null, avgType, cx, false, true);
    ...
    private SqlNode expandR2(
        final SqlNode arg1, final SqlNode arg2,
        final RelDataType avgType, final SqlRexContext cx) {
      final SqlParserPos pos = SqlParserPos.ZERO;
      final SqlNode varPop1 = expandCovariance(arg1, arg1, arg2, avgType, cx, false, false);
      final SqlNode varPop2 = expandCovariance(arg2, arg2, arg1, avgType, cx, false, false);
    ...
    private SqlNode expandRegrIntercept(
        final SqlNode arg1, final SqlNode arg2,
        final RelDataType avgType, final SqlRexContext cx) {
      final SqlParserPos pos = SqlParserPos.ZERO;
    ...
    private SqlNode expandRegrSlope(
        final SqlNode arg1, final SqlNode arg2,
        final RelDataType avgType, final SqlRexContext cx) {
      final SqlParserPos pos = SqlParserPos.ZERO;
      final SqlNode covarPop = expandCovariance(arg1, arg2, null,  avgType, cx, true, false);
      final SqlNode varPop = expandCovariance(arg2, arg2, arg1, avgType, cx, true, false);
      final RexNode varPopRex = cx.convertExpression(varPop);
      final SqlNode varPopCast;
      varPopCast = getCastedSqlNode(varPop, avgType, pos, varPopRex);
